...
//            cycle.backgroundColor = loadingTintColor.cgColor
            ...
            cycle.transform = CATransform3DMakeRotation(CGFloat(Double.pi * 2 * Double(i)), 0, 0, 1)
        }
    }
...
extension STPacManLoading: STLoadingable {
    internal func startLoading() {
        ...
        for i in 0..<cycleCount {
            ...
            rotateAnimation.fromValue = Double.pi * 2 * Double(i)
            rotateAnimation.toValue = Double.pi * 2 * Double(i) + (-Double.pi * 2 * 3)
